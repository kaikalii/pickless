...
execute as @e[tag=!pickless.processed] run function pickless:for_each_material {function:"replace/entity/material"}
execute as @e[tag=!pickless.processed] run tag @s add pickless.processed

schedule function pickless:replace/entity/material 1s
