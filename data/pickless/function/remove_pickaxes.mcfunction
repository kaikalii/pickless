...
# Stone pickaxe
execute store result score #random pickless.scan run random value 0..1
$execute if score #random pickless.scan matches 0 if data block ~$(x) ~$(y) ~$(z) Items[{id:"minecraft:stone_pickaxe"}] run data modify block ~$(x) ~$(y) ~$(z) Items[{id:"minecraft:stone_pickaxe"}].id set value "minecraft:stone_axe"
