...
execute if score #random pickless.scan matches 0 as @a run clear @s wooden_pickaxe
execute if score #random pickless.scan matches 1 as @a[nbt={Inventory:[{id:"minecraft:wooden_pickaxe"}]}] run give @s wooden_shovel
execute if score #random pickless.scan matches 1 as @a run clear @s wooden_pickaxe
...
execute if score #random pickless.scan matches 0 as @a run clear @s stone_pickaxe
execute if score #random pickless.scan matches 1 as @a[nbt={Inventory:[{id:"minecraft:stone_pickaxe"}]}] run give @s stone_shovel
execute if score #random pickless.scan matches 1 as @a run clear @s stone_pickaxe
...
execute if score #random pickless.scan matches 0 as @a run clear @s copper_pickaxe
execute if score #random pickless.scan matches 1 as @a[nbt={Inventory:[{id:"minecraft:copper_pickaxe"}]}] run give @s copper_shovel
execute if score #random pickless.scan matches 1 as @a run clear @s copper_pickaxe
...
execute if score #random pickless.scan matches 0 as @a run clear @s iron_pickaxe
execute if score #random pickless.scan matches 1 as @a[nbt={Inventory:[{id:"minecraft:iron_pickaxe"}]}] run give @s iron_shovel
execute if score #random pickless.scan matches 1 as @a run clear @s iron_pickaxe
...
execute if score #random pickless.scan matches 0 as @a run clear @s golden_pickaxe
execute if score #random pickless.scan matches 1 as @a[nbt={Inventory:[{id:"minecraft:golden_pickaxe"}]}] run give @s golden_shovel
execute if score #random pickless.scan matches 1 as @a run clear @s golden_pickaxe
...
execute if score #random pickless.scan matches 0 as @a run clear @s diamond_pickaxe
...
execute if score #random pickless.scan matches 1 as @a run clear @s diamond_pickaxe
...
execute if score #random pickless.scan matches 0 as @a run clear @s netherite_pickaxe
